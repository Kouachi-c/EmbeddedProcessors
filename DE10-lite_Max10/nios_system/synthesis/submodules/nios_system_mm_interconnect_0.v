...
module nios_system_mm_interconnect_0 (
	...
	wire  [97:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire  [97:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> ledr_s1_agent:cp_data
	...
	wire  [10:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [97:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> hex0_s1_agent:cp_data
	...
	wire  [97:0] cmd_mux_008_src_data;                                                        // cmd_mux_008:src_data -> hex1_s1_agent:cp_data
	...
	wire  [10:0] cmd_mux_009_src_channel;                                                     // cmd_mux_009:src_channel -> hex2_s1_agent:cp_channel
	...
	wire  [97:0] cmd_mux_010_src_data;                                                        // cmd_mux_010:src_data -> hex3_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                       // hex3_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                                     // cmd_mux_010:src_channel -> hex3_s1_agent:cp_channel
	...
	wire  [97:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [97:0] ledr_s1_agent_rp_data;                                                       // ledr_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [97:0] hex0_s1_agent_rp_data;                                                       // hex0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [97:0] hex1_s1_agent_rp_data;                                                       // hex1_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [97:0] hex3_s1_agent_rp_data;                                                       // hex3_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [97:0] router_src_data;                                                             // router:src_data -> nios2_data_master_limiter:cmd_sink_data
	...
	wire  [97:0] nios2_data_master_limiter_cmd_src_data;                                      // nios2_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [97:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_limiter:rsp_sink_data
	...
	wire  [97:0] nios2_data_master_limiter_rsp_src_data;                                      // nios2_data_master_limiter:rsp_src_data -> nios2_data_master_agent:rp_data
	...
	wire  [97:0] router_001_src_data;                                                         // router_001:src_data -> nios2_instruction_master_limiter:cmd_sink_data
	...
	wire  [97:0] nios2_instruction_master_limiter_cmd_src_data;                               // nios2_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [97:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_limiter:rsp_sink_data
	...
	wire  [97:0] nios2_instruction_master_limiter_rsp_src_data;                               // nios2_instruction_master_limiter:rsp_src_data -> nios2_instruction_master_agent:rp_data
